...
function Database() {
    ...
    async function setdata() {
        ...
        fetch('https://note-backend-iyv7.onrender.com/setdata', option)
    ...
    useEffect(() => {
        let arr = [];
        function getdata() {
            fetch("https://note-backend-iyv7.onrender.com/getdata")
    ...
    function deletedata(e) {
        ...
        fetch('https://note-backend-iyv7.onrender.com/deletedata', option)
            .then(responce => responce.json())
            .then(result => {
                console.log(result);
                setcheck(!getcheck);
    ...
    function deleteall()
    {
        ...
        fetch('https://note-backend-iyv7.onrender.com/deleteall',option)
        .then(responce=>responce.json())
        .then(result=>
        {
            console.log(result)
    ...
    function editdata(e) {
        ...
        fetch('https://note-backend-iyv7.onrender.com/edit', option)
            .then(responce => responce.json())
            .then(result => {
                console.log(result)
                if (result.status == 200) {
